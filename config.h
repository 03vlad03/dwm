...
static const char col_gray3[]       = "#93FF93";
static const char col_gray4[]       = "#F88CD7";
static const char col_green[]       = "#00782C";
static const char col_pink[]        = "#FF58CD";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_green,  col_pink },
};
